...
public class Tab6Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mListView.setAdapter(new ProductAdapter(getActivity(),R.layout.item_list_build_pc, DatabaseHandle.getInstance(getActivity()).getListProductModels("Ssd_Hdd",MainActivity2.color,"")));
        return view;
    }
