...
public class VgaAdapter extends ArrayAdapter<ProductModel> {
    private Context context;
    private int resource;
    private List<ProductModel> cpuModelList;

    public VgaAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<ProductModel> objects) {
